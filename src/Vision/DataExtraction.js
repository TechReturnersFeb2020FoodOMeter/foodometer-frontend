            ...
            <form>
                <div className="row">
                    <div className="col col-md-5" >
                        <input type="text"  className="form-control" placeholder="Product_Name" onChange={handleProdChange} value={selectedValue} id="product"/>
                    </div>
                    <div className="col col-md-4">
                        <input type="date" className="form-control" placeholder="Last name" onChange={handleDateChange} value={date} />
                    </div>
                    <div className="col col-md-3">
                        <input type="text" className="form-control" placeholder="Reminder" onChange={handleReminderChange} value={reminder} />
                    </div>
                </div>
                <div className="row justify-content-center my-3">
                    <button class="btn btn-primary" type="button" id="additembtn" onClick={handleAddTask}>Add Item</button>
                </div>
            </form>
