      ...
      <div>
        ...
        {itemList.map((item) => {
          return (
            ...
            <div className="row dashboard">
              <div className="col-6 col-md-4 my-3">{item.item_name}</div>
              <div className="col-6 col-md-2 my-3">{item.expiry_date}</div>
              <div className="col col-md-3 my-3">{item.reminder}</div>
              <div className="col col-md-3 my-3">
                <button
                  type="button"
